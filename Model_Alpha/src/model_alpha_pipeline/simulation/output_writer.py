...
def write_simulation_output(
    ...
    hf.create_dataset(f'images/strong_lens_{i}/snr', data=np.array([str(SNR), 'SNR of lensed in all bands'],dtype=dt),dtype=dt)
    ...
    exposure_0=hf.create_dataset(f'images/strong_lens_{i}/exposure_{i}_{dlu_2_results.band_labels[0]}',data = img[0])
    ...
    hf.create_dataset(f'images/strong_lens_{i}/exposure_{i}_{dlu_2_results.band_labels[0]}_nss',data = img_nss[0])

    exposure_1=hf.create_dataset(f'images/strong_lens_{i}/exposure_{i}_{dlu_2_results.band_labels[1]}',data = img[1])
    ...
    hf.create_dataset(f'images/strong_lens_{i}/exposure_{i}_{dlu_2_results.band_labels[1]}_nss',data = img_nss[1])
    
    exposure_2=hf.create_dataset(f'images/strong_lens_{i}/exposure_{i}_{dlu_2_results.band_labels[2]}',data = img[2])
