...
def generate_images(setup_results, dlu_1_results,dlu_2_results):
    kwargs_numerics = {'point_source_supersampling_factor': 1}
    
    img_g,img_r,img_i,tot_exp_times = simulate(kwargs_numerics=kwargs_numerics,band_kwargs=dlu_2_results.bands,lens_light_kwargs=setup_results['kwargs_lens_light_mag'],source_light_kwargs=setup_results['kwargs_source_mag'],lens_nonlight_kwargs=dlu_1_results.lens_kwargs_list,kwargs_model_=setup_results['kwargs_model'])
    
    img_nss_g,img_nss_r,img_nss_i,_ = simulate(kwargs_numerics=kwargs_numerics,band_kwargs=dlu_2_results.bands,lens_light_kwargs=setup_results['kwargs_lens_light_mag'],source_light_kwargs=setup_results['kwargs_source_mag'],lens_nonlight_kwargs=setup_results['macro_kwargs_list_nss'],kwargs_model_=setup_results['kwargs_model_nss'])
