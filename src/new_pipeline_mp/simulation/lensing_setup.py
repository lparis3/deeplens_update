...
def build_lensing_setup(sampled_vals, dlu_1_results,dlu_2_results,light_profile='INTERPOL'):
    ...
    #NOTE: mass_to_radius_arcsec(sampled_M_host) != sampled theta_E. Trust sampled theta_E more so we will set theta_E_nss as sampled theta_E
    #theta_E_nss_arcsec = mass_to_radius_arcsec(dlu_1_results.host_mass,zsource,zdeflector,dlu_1_results)
    #print(f'theta_E_Host is {dlu_1_results.macro_kwargs_list[0]["theta_E"]}')
    #print(f'theta_E_nss is {theta_E_nss_arcsec}')
    
    
    Host_kwargs_nss = {'theta_E':dlu_1_results.macro_kwargs_list[0]["theta_E"],'gamma': dlu_1_results.macro_kwargs_list[0]['gamma'],'e1':0.0,'e2':0.0,'center_x':0.0, 'center_y':0.0} 
